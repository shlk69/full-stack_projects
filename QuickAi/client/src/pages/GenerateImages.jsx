    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      <form
        ...
        <textarea
          ...
          placeholder="Describe what you wanna see in the Image.."
          required
        />
        ...
        <button
          ...
          {loading ? "Generating Image..." : "Generated Image"}
        </button>
      </form>
      {/* Right col */}
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          {content && (
            <button
              ...
              className="flex items-center gap-2 rounded-md border border-green-600 px-3 py-2 text-sm font-medium text-green-700 transition hover:bg-green-50">
