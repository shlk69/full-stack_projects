    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      <form
        ...
        <div className="flex items-center gap-2">
          <Sparkles className="w-6 text-[#0099b3]" />
          <h1 className="text-lg font-semibold"> AI Resume Reviewer </h1>
        </div>
        ...
        <button
          disabled={loading}
          className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00da83] to-[#0099b3] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer">
          {loading ? (
