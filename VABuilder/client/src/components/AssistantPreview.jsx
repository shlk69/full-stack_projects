...
const themes = {
  dark: {
    ...
    micGlow: "shadow-[0_0_60px_rgb a(168,85,247,0.45)]",
  },
      ...
      <div
        ...
        <div className="relative z-20 flex flex-col items-center justify-between h-full px-5 py-6 sm:px-7 sm:py-8">
          <div className="relative mt-1">
            ...
            <div
              className={`relative w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full bg-gradient-to-br ${current.orb} shadow-[0_0_12px_rgba(255,255,255,0.15)] animate-pulse before:absolute before:inset-0 before:rounded-full before:bg-white/20 before:blur-xl`}
            />
          </div>
          ...
          <div className="relative mb-1">
            ...
            <button
              ...
              <CiMicrophoneOn size={25} className=" text-[#000000]" />
            </button>
                  </div>
